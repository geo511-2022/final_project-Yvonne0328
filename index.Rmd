...
```{r, message=F, warning=F}
steps <- c("before", "during", "after", "after2", "after3")
...
# Results
Word clouds can help us understand the topic trend in each timeframe. 
...
timeframe <- c("-1", "0", "1", "2", "3")
names <- c("before", "during", "3D-after", "6D-after", "9D-after")
trend <- data.frame(names,timeframe, SCORE)

ggplot(trend, aes(x= factor(names,level = c("before", "during", "3D-after", "6D-after", "9D-after")), SCORE, group = 1))+
